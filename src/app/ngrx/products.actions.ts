...
export class GetAllProductsSuccess implements Action{
    readonly type : ProductsActionTypes = ProductsActionTypes.GET_ALL_PRODUCTS_SUCCESS;
    constructor(public payload : any ){}
...
export class GetAllProductsFailure implements Action{
    readonly type : ProductsActionTypes =  ProductsActionTypes.GET_ALL_PRODUCTS_FAILURE;
...
export type ProductsActions = GetAllProductsAction | GetAllProductsSuccess | GetAllProductsFailure ;